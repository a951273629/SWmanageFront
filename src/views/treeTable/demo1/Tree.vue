  ...
  <div class="com-el-tree">
    <!-- <div class="m-title"><i class="el-icon-warning-outline"></i>角色列表</div>
     ...
     <div class="search-block">
        <!--   v-if="singleSearch" -->
        <el-input class="search-input" v-model="input" placeholder="请输入关键字搜索"  />
        <el-button size="small" type="primary" :icon="Search"  @click="search"  class="search-button">
...
.search-block{
  ...
  * {
  ...
  .search-input {
    ...
    width: 80%;
    --el-border-radius-base: 10px 0px 0px 10px;
    font-size:10px;
  }
  .search-button{
    width: 20%;
