...
let viewgird = [
  ...
  , {
   ...
   ,{
        ...
        path: '/Store_ProviderRegular',
        name: 'Store_ProviderRegular',
        component: () => import('@/views/manage/store_providerregular/Store_ProviderRegular.vue')
    }    ,{
        path: '/Finished_Check_Ticket',
        name: 'Finished_Check_Ticket',
        component: () => import('@/views/manage/finished_check_ticket/Finished_Check_Ticket.vue')
    }    ,{
        path: '/Finished_Check_Works',
        name: 'Finished_Check_Works',
        component: () => import('@/views/manage/finished_check_works/Finished_Check_Works.vue')
    }    ,{
        path: '/CatalogTree',
        name: 'CatalogTree',
        component: () => import('@/views/manage/catalogtree/CatalogTree.vue')
    }    ,{
        path: '/Catalog_Record',
        name: 'Catalog_Record',
